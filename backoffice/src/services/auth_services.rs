use crate::{
    ...
    services::user_helper_services::{UserHelperService, UserHelperServiceTrait},
};
    ...
    AuthenticationServiceTrait for AuthenticationService<R, T, E>
{
    ...
    async fn login(
        ...
        let access_token = self
            .token_service
            .generate_token(&access_claims, access_token_ttl_secs)?;
        ...
        let refresh_token = self
            .token_service
            .generate_token(&refresh_claims, refresh_token_ttl_secs)?;
    ...
    async fn request_refresh_token(
        ...
        let new_refresh_token = self
            .token_service
            .generate_token(&new_refresh_claims, refresh_token_ttl_secs)?;
        let refresh_token_expiry = now + refresh_token_ttl_secs as i64;
...
mod tests {
    ...
    async fn request_refresh_token_success() {
        ...
        token_service.expect_validate_token().returning(|_| {
            Ok(TokenClaims {
                email: "user@test.com".to_string(),
                identifier: "user-001".to_string(),
                token_type: "refresh".to_string(),
