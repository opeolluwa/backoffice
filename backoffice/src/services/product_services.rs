use crate::{
    ...
    models::products::Model as Product, repositories::product_repository::ProductRepositoryExt,
};
...
mod tests {
    use super::*;
    use crate::repositories::product_repository::MockProductRepositoryExt;
