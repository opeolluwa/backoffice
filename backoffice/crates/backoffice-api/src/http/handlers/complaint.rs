...
use backoffice_domain::dto::{CreateComplaintCommand, UpdateComplaintCommand};
use backoffice_domain::errors::api_response::ApiResponse;
use backoffice_domain::errors::service_error::ServiceError;
use backoffice_domain::models::complaints;
use backoffice_domain::services::complaint::ComplaintServiceExt;
...
pub async fn create_complaint(
    ...
    let result = state.services.complaint_service.create_complaint(command).await?;
...
pub async fn find_all_complaints(
    ...
    ApiResponse<Vec<(complaints::Model, Option<backoffice_domain::models::customers::Model>)>>,
    ServiceError,
> {
    let results = state.services.complaint_service.find_all_complaints().await?;
...
pub async fn find_complaint_by_identifier(
    ...
    ApiResponse<(complaints::Model, Option<backoffice_domain::models::customers::Model>)>,
    ServiceError,
> {
    let result = state
        .services
